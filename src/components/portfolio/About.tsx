  ...
  return (
    <section id="about" className="border-t border-hairline bg-surface/40 py-24 md:py-32">
      <div className="mx-auto max-w-6xl px-6">
          ...
          <ScrollReveal variant="stagger-container" className="flex flex-col">
            ...
            <ScrollReveal variant="stagger-item">
              <p className="mt-5 max-w-xl text-base leading-relaxed text-muted-foreground">
                I'm Feri, a web developer based in Indonesia. Over the past three years, I've honed
                my skills to high-quality, high-performance projects—with a focus on design systems,
                clean code, and modern interfaces.
              </p>
            </ScrollReveal>
        ...
        <ScrollReveal variant="stagger-container" className="mt-16 grid gap-4 sm:grid-cols-3">
          {stats.map((s) => {
            const Icon = s.icon;
            return (
              <ScrollReveal
